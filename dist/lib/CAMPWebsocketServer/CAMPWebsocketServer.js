...
export class CAMPWebsocketServer extends EventEmitter {
    server;
    tokenValidator;
    ...
    constructor(server, tokenValidator, keepAliveInterval, socketPort, backpressure_options, extensionRegistry = new CAMPServerExtensionRegistry()) {
        super();
        this.server = server;
